...
class MainWindow(qtw.QWidget):
    ...
    def func_result(self):
        empty_string = 'Please Input Value' # Set the empty_string value as a string
        if self.fin_nums==[] or self.temp_nums==[]: # If fin_nums or temp_nums string is empty
            self.results_field.setText(empty_string) # Set results_field to empty_string value
        else:
